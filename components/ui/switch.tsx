    ...
    >
      <SwitchPrimitives.Thumb
        className={cn(
          ...
          isRTL 
            ? "data-[state=checked]:translate-x-0 data-[state=unchecked]:-translate-x-[18px] peer-disabled:-translate-x-[5px]"
            : "data-[state=checked]:translate-x-[18px] data-[state=unchecked]:translate-x-[2px] peer-disabled:-translate-x-[5px]"
        )}
      />
    </SwitchPrimitives.Root>
  )
