 ...
 * שימוש: node scripts/delete-all-customers.mjs
 * 
...
async function deleteAllCustomers() {
  try {
    ...
    console.log('⚠️  פעולה זו תמחק גם את כל הנתונים הקשורים\n')
    ...
    // מוחק את כל ההזמנות, לא רק אלו עם לקוחות
    ...
    console.log('\n✅ כל הלקוחות וההזמנות נמחקו בהצלחה!')
    console.log(`📊 סה"כ נמחקו ${deletedCustomers.count} לקוחות`)
    console.log(`📊 סה"כ נמחקו ${deletedOrders.count} הזמנות\n`)
