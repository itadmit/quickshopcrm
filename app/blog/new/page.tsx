      ...
      <AppLayout title="פוסט חדש">
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-4">
            יש לבחור חנות מההדר לפני יצירת פוסט
          </p>
    ...
    <AppLayout title="פוסט חדש">
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">פוסט חדש</h1>
            <p className="text-gray-600 mt-1">צור פוסט חדש בבלוג</p>
          </div>
