...
export default function EditProductPage() {
  ...
  const shopUrl = product.shop ? getShopProductUrl(product.shop.domain || product.shop.slug, product.slug) : null
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <ProductAddonsCard
              ...
              selectedAddons={productAddonIds}
          ...
          <div className="space-y-6">
            ...
            <SEOCard
              ...
              onChange={(data) => setFormData(prev => ({ ...prev, ...data }))}
              shopDomain={product.shop?.domain || product.shop?.slug || ""}
            />
          </div>
        </div>
      </div>
